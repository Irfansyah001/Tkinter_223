...
root.configure(bg="#2b2b2b")  # Warna background jendela

# Label Judul
judul_label = tk.Label(root, text="Aplikasi Prediksi Prodi Pilihan", font=("Arial", 18, "bold"), bg="#2b2b2b")
...
hasil_label = tk.Label(root, text="", font=("Arial", 14, "italic", "bold"), fg="black", bg="#2b2b2b")
